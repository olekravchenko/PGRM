...
double X0, X1, Y0, Y1;
//int N;
double f6(double x, double y) {return -2*y*(3*pow(x,8) + 2*pow(x,6)*(-83 + 24*pow(y,2)) + 
     pow(x,4)*(915 - 490*pow(y,2) + 51*pow(y,4)) - 
     8*(-74 + 149*pow(y,2) - 52*pow(y,4) + pow(y,6)) + 
     2*pow(x,2)*(-744 + 715*pow(y,2) - 150*pow(y,4) + 3*pow(y,6)));}
